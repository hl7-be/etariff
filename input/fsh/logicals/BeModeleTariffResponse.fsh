...
* service.tariff.supplement 1..1 Money "Personal co-payment paid by the patient"
...
* service.refusal.code 0..1 CodeableConcept "Nomenclature code of the service justifying the refusal"
* service.refusal.date 0..1 dateTime "Date of the service justifying the refusal"